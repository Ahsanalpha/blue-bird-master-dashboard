...
//   active_tenants: 0,
//   cancelled_tenants: 0,
//   enterprise_plan_tenants: 0,
//   free_plan_tenants: 0,
//   monthly_billing_tenants: 0,
//   standard_plan_tenants: 0,
//   suspended_tenants: 0,
//   total_tenants: 0,
//   yearly_billing_tenants: 0,
// }
...
export default function DashboardPage() {
    ...
    useEffect(() => {
      const fetchStats = async () => {
        try {
          const data = await tenantApi.getTenantStats()
          setStatsData(data)
        } catch (error) {
  ...
  return (
    <div className="flex flex-col gap-4">
      <div>
        <h1 className="text-2xl md:text-3xl font-bold tracking-tight">Tenants Stats</h1>
        <p className="text-muted-foreground">Overview of tenant statistics and performance metrics.</p>
      </div>
      ...
      <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{statsData?.allStats?.total_tenants}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{statsData?.allStats?.suspended_tenants}</div>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Cancelled Tenants</CardTitle>
      ...
      <div className="grid gap-4 grid-cols-1 sm:grid-cols-3">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Free Plan Tenants</CardTitle>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Standard Plan Tenants</CardTitle>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Enterprise Plan Tenants</CardTitle>
      ...
      <div className="grid gap-4 grid-cols-1 sm:grid-cols-2">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Monthly Billing Tenants</CardTitle>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Yearly Billing Tenants</CardTitle>
      ...
      {/* <Tabs defaultValue="daily" className="space-y-4">
        ...
        <TabsContent value="daily" className="space-y-4">
          <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-6">
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">New Tenants Today</CardTitle>
                <Building2 className="h-4 w-4 text-muted-foreground" />
              </CardHeader>
              <CardContent>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">60% of tenants</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">20% of tenants</p>
              </CardContent>
            </Card>
        ...
        <TabsContent value="weekly" className="space-y-4">
          <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-6">
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">New Tenants This Week</CardTitle>
                <Building2 className="h-4 w-4 text-muted-foreground" />
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold">3</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">5</div>
                <p className="text-xs text-muted-foreground">100% retention</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">3</div>
                <p className="text-xs text-muted-foreground">+1 upgrade</p>
              </CardContent>
            </Card>
        ...
        <TabsContent value="monthly" className="space-y-4">
          <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-6">
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">New Tenants This Month</CardTitle>
                <Building2 className="h-4 w-4 text-muted-foreground" />
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold">5</div>
                <p className="text-xs text-muted-foreground">All current tenants</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">3</div>
                <p className="text-xs text-muted-foreground">60% premium adoption</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">$11,360</div>
                <p className="text-xs text-muted-foreground">Strong MRR base</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">$2,272</div>
                <p className="text-xs text-muted-foreground">High value tenants</p>
              </CardContent>
            </Card>
          </div>
        </TabsContent>
      ...
      {/* <div className="grid gap-4 grid-cols-1 lg:grid-cols-7">
        <Card className="lg:col-span-4">
          <CardHeader>
            ...
            <CardDescription>Monthly recurring revenue from tenant subscriptions</CardDescription>
          </CardHeader>
        ...
        <Card className="lg:col-span-3">
          <CardHeader>
            ...
            <CardDescription>Latest tenant subscription payments and renewals</CardDescription>
          </CardHeader>
          <CardContent>
            <RecentTransactions />
          </CardContent>
